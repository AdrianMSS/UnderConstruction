$(window).load(function() {
	...
	setTimeout(function() {
        $("#fullscreen-ytb").addClass("fadeInUp").removeClass("opacity-0");
    }, 4700);
...
$(document).ready(function($) {
	...
	// Full screen Youtube
    $('#fullscreen-ytb').click(function() {
        $(".left-part").addClass("fadeOutLeft").removeClass("fadeInLeft");
        $(".middle-part").addClass("fadeOutRight").removeClass("fadeInRight");
        $(".right-part").addClass("fadeOutRight").removeClass("fadeInRight");
        $(".social-icons").addClass("fadeOutUp").removeClass("fadeInDown");
        $(".overlay-map").addClass("display-none").removeClass("");
        setTimeout(function() {
            $("button.close-youtube").addClass("fadeInLeft").removeClass("fadeOutLeft").css("left", "0");
        }, 850);
        setTimeout(function() {
            $("button.close-youtube i").addClass("bounceInDown");
        }, 1200);
        setTimeout(function() {
            $("button.close-youtube i").addClass("flash").removeClass("bounceInDown");
        }, 2401);
        setTimeout(function() {
            $(".left-part").css("left", "-50vw");
            $(".middle-part").css("left", "100vw");
            $(".right-part").css("left", "150vw");
    ...
    $('button.close-youtube').on('click', function() {
        ...
        $(".right-part").css("left", "100vw").addClass("fadeInRight").removeClass("fadeOutRight");
        $(".social-icons").addClass("fadeInDown").removeClass("fadeOutUp display-none");
        $("button.close-youtube").addClass("fadeOutLeft").removeClass("fadeInLeft");
        $("button.close-youtube i").removeClass("flash");
        setTimeout(function() {
            $("button.close-youtube").css("left", "-100px");
        }, 800);
    });
		...
		buildPlayer: function (options) {
			...
			return this.each(function () {
				...
				if (YTPlayer.isBackground) {
					...
					wrapper.css({position: "fixed", top: 0, left: 0, zIndex: 5, webkitTransform: "translateZ(0)"});
					$YTPlayer.hide();
